> Source: https://github.com/carbon-design-system/carbon/blob/main/packages/styles/README.md
...
checkout the [configuration](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/docs/sass.md#configuration) section in our Sass
docs.
...
[Sass docs](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/docs/sass.md#files).
...
[theming documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/themes/docs/sass.md#tokens).

## 📖 API Documentation

If you're looking for `@carbon/styles` API documentation, check out:

- [Sass](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/docs/sass.md)
