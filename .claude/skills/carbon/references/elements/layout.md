> Source: https://github.com/carbon-design-system/carbon/blob/main/packages/layout/README.md
...
check out the [`@carbon/grid`](https://github.com/carbon-design-system/carbon/blob/main/packages/grid) package.
