> Source: https://github.com/carbon-design-system/carbon/blob/main/packages/web-components/README.md
...
[v3 migration guide](https://github.com/carbon-design-system/carbon/blob/main/docs/guides/cwc-v3-migration.md) to prepare.
...
- [Using components in a form](https://github.com/carbon-design-system/carbon/blob/main/packages/web-components/docs/form.md)
- [Using custom styles in components](https://github.com/carbon-design-system/carbon/blob/main/packages/web-components/docs/styling.md)
- [Migrating to v3](https://github.com/carbon-design-system/carbon/blob/main/docs/guides/cwc-v3-migration.md)
