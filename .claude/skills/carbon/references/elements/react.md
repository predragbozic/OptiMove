> Source: https://github.com/carbon-design-system/carbon/blob/main/packages/react/README.md
...
checkout the [configuration](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/docs/sass.md#configuration) section in
our Sass docs.
