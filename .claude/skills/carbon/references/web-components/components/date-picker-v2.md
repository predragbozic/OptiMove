> Source: https://github.com/carbon-design-system/carbon/blob/main/packages/web-components/src/components/date-picker/next/__stories__/date-picker-v2.mdx
...
- The `cds-preview-date-picker-input` component takes in similar attributes to
  ...
  [text input](https://github.com/carbon-design-system/carbon/blob/main/packages/web-components/src/components/date-picker/next/?path=/docs/components-text-input--overview) page.
