> Source: https://github.com/carbon-design-system/carbon/blob/main/docs/guides/colors.md
...
available to edit [in this directory](https://github.com/carbon-design-system/carbon/blob/main/packages/colors/src). There are a couple
of files, namely:
...
[`colors.js`](https://github.com/carbon-design-system/carbon/blob/main/packages/colors/src/colors.js) file. This file is written in
...
[`themes`](https://github.com/carbon-design-system/carbon/blob/main/packages/themes/src) folder. This folder will have files that are
named for each theme we currently support. The
[`white`](https://github.com/carbon-design-system/carbon/blob/main/packages/themes/src/white.js) theme is considered the default theme.
