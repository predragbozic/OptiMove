> Source: https://github.com/carbon-design-system/carbon/blob/main/docs/feature-flags.md
...
[`@carbon/upgrade` README](https://github.com/carbon-design-system/carbon/blob/main/packages/upgrade/README.md#feature-flag-codemods).
...
After enabling v12, see the [v12 migration impact](https://github.com/carbon-design-system/carbon/blob/main/docs/migration/v12.md) for
