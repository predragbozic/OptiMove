> Source: https://github.com/carbon-design-system/carbon/blob/main/docs/migration/v11.md
...
[`@carbon/upgrade`](https://github.com/carbon-design-system/carbon/blob/main/packages/upgrade/README.md) package to help with
migration.
...
[documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/scss/fonts/README.md).
...
[API documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/motion/docs/sass.md#api) for the
...
For a full overview of what is available in this entry point, check out the
[API documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/layout/docs/sass.md#api) for the
...
[API documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/docs/sass.md#theme).
...
For a full overview of what is available in this entry point, check out the
[API documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/type/docs/sass.md#api) for `@carbon/type`.
...
[the sass documentation for `@carbon/styles`](https://github.com/carbon-design-system/carbon/blob/main/packages/styles/docs/sass.md#components).
...
instructions in [`@carbon/upgrade`](https://github.com/carbon-design-system/carbon/blob/main/packages/upgrade/README.md).
...
[Sass Documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/colors/docs/sass.md) for this package.
...
For full Sass API documentation, visit the
[Sass Documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/elements/docs/sass.md) for this package.
...
[Sass Documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/grid/docs/sass.md) for the package.
...
For full documentation, visit the
[Sass Documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/layout/docs/sass.md) for the package.
...
For full documentation, visit the
[Sass Documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/motion/docs/sass.md) for the package.
...
For full Sass API documentation, visit the
[Sass Documentation](https://github.com/carbon-design-system/carbon/blob/main/packages/themes/docs/sass.md) for this package.
