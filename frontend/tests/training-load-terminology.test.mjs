...
test("the Data & Analysis sub-nav labels are Overview / Activities / Athletes / Dashboards - never 'Results'", async () => {
  ...
  assert.deepEqual(labels, ["Overview", "Activities", "Athletes", "Dashboards"]);
});
